<?php
// php/modulos/pagos/rechazados.php
session_start();
...
$titulo = "Historial de Pagos Rechazados";
...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="../../../styles/rechazados.css">
...
<body>
    ...
    <div class="content-pagos">
        <div class="modulo-pagos">
            <div class="modulo-header">
                <h2><i class="fas fa-times-circle"></i> <?php echo $titulo; ?></h2>
            </div>
            
            <!-- Lista de Pagos Rechazados -->
            <div class="seccion-metodos">
                <h3><i class="fas fa-ban"></i> Historial de Pagos Rechazados</h3>
                <div id="lista-rechazados">
    ...
    <!-- JavaScript -->
    <script src="../../../scripts/pagos_rechazados.js"></script>
</body>
</html>